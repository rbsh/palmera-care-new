...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{url('backend')}}/assets/pages/css/error.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" page-404-3">
        <div class="page-inner">
            <img src="{{url('backend')}}/assets/pages/media/pages/earth.jpg" class="img-responsive" alt=""> </div>
        <div class="container error-404">
            <h1>oops !!!!</h1>
            <h2>Your account is currently locked</h2>
            <p> Please contact adminsitrator to get your account back</p>
            <p>
                <a href="{{url('la-admin/login')}}" class="btn red btn-outline"> Return home </a>
                <br> </p>
        </div>
        <!--[if lt IE 9]>
